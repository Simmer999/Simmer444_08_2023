...
const color = d3.scale.ordinal()
 .range(["#0000cc", "orange", "#005500", "#bb5500", "#00cccc", "#5500aa","#aa0000"]);

 //Get the data.           
d3.csv("AT.csv", function(error, data) { //  <<-------------
//console.log(data)
...
const keys = ["Total Hours", "Node, Express, JavaScript", "D3", "THREE", 
 "HTML, CSS", "C#, R, React, Cheerio, ", "WordPress, SquareSpace"]

// Usually you have a color scale in your chart already 
const colour = d3.scale.ordinal()
    .domain(keys)
    .range(["#0000cc", "#005500", "#5500aa","#aa0000", 
